<li class=" treeview">
    ...
    <ul class="treeview-menu">
        <li class="active"><a href="{{url('/adminpanel/sitesetting')}}"><i class="fa fa-circle-o"></i> الاعدادات الرئيسيه</a></li>
...
<li class=" treeview">
    <a href="#">
        ...
        <span style="margin-right: 25px;">التحكم في الاعضاء</span>
        <i class="fa fa-angle-left pull-left"></i>
        <div class="clearfix"></div>
...
<li class=" treeview">
    <a href="#">
        <i class="fa phpdebugbar-fa-mail-forward pull-right"></i>
